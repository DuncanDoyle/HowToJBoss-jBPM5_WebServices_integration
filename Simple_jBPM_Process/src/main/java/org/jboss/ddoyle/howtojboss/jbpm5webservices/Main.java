...
public class Main {
	...
	public static void main(String[] args) {
		...
		sks.getWorkItemManager().registerWorkItemHandler("PaymentService", paymentServiceWIH);
	...
	private static StatefulKnowledgeSession getSKS() {
		...
		kbuilder.add(ResourceFactory.newClassPathResource("jbpm5-process-definitions/org.jboss.ddoyle.howtojboss.jbpm5webservices.simple-webservices-integration-process.v1.bpmn2"), ResourceType.BPMN2);
